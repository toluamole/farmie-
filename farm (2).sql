...
(2, 'Darlington', '6fb42da0e32e07b61c9f0251fe627a9c', 0, '2020-02-01 10:05:26');
...
CREATE TABLE `plants` (
  ...
  `BotanicalName` varchar(200) NOT NULL,
  `PlantingSeason` varchar(200) NOT NULL,
  `SoilType` varchar(200) NOT NULL,
  `PlantingRequirements` text NOT NULL,
  `Kingdom` varchar(200) NOT NULL,
  `Phylum` varchar(200) NOT NULL,
...
INSERT INTO `plants` (`id`, `PlantName`, `BotanicalName`, `PlantingSeason`, `SoilType`, `PlantingRequirements`, `Kingdom`, `Phylum`, `Class`, `Family`, `Species`, `date`) VALUES
(1, 'kuvhjk', ',jk,j', 'kujjhlkju', 'blkjvk', 'ujvku', 'yvkuyvk', 'ujyvukvu', 'kyvku', 'yvukuvku', 'vkyjb', '2020-02-17 15:20:55');
